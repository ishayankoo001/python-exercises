...
class Test(testlib.TestCase):
    ...
    def do_test(self, root, expected):
        '''Test implementation
            - root : JSON file containing the list of edges
            - expected : expected maximum width of the tree
        '''
        tree1 = copy.deepcopy(root)
        try:
    ...
    def test(self, lista, expected):
        root = tree.BinaryTree.fromList(lista)
